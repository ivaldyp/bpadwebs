				...
				<div class="col-md-8">
					...
					@csrf
						<div class="panel panel-info">
							<div class="panel-heading"> Lihat Pinjaman </div>
							<div class="panel-wrapper collapse in" aria-expanded="true">
								<div class="panel-body">
									<div class="form-group">
										<label for="nm_emp" class="col-md-2 control-label"> Nama Peminjam </label>
										<div class="col-md-8">
											<input autocomplete="off" type="text" name="nm_emp" class="form-control" value="{{ strtoupper($booking['nm_emp']) }}" disabled="">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input autocomplete="off" type="text" name="id_emp" class="form-control" value="{{ $booking['id_emp'] }}" disabled="">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<p class="form-control-static">{{ $booking['unit_emp'] }} - {{ $booking['nmunit_emp'] }}</p>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<p class="form-control-static">{{ $ruangs['nm_ruang'] }}</p>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input autocomplete="off" type="text" name="tujuan" id="tujuan" class="form-control" required="" disabled="" value="{{ $booking['tujuan'] }}">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<input autocomplete="off" type="text" name="peserta" id="peserta" class="form-control"  value="{{ $booking['peserta'] == '' ? '0' : $booking['peserta'] }}" disabled="">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											...
											<input type="text" class="form-control datepicker-autoclose" id="tgl_pinjam" name="tgl_pinjam" autocomplete="off" value="{{ date('d-M-Y',strtotime($booking['tgl_pinjam'])) }}" disabled="">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<div class="input-group clockpicker" data-placement="bottom" data-align="top" data-autoclose="true">
												<input type="text" class="form-control" value="{{ $splitmulai[0] }}:{{ $splitmulai[1] }}" name="time1" id="time1" disabled=""> <span class="input-group-addon"> <span class="glyphicon glyphicon-time"></span> </span>
											</div>
										</div>
										<label for="tgl_masuk" class="col-md-2 control-label"> Selesai </label>
										<div class="col-md-3">
											<div class="input-group clockpicker" data-placement="bottom" data-align="top" data-autoclose="true">
												<input type="text" class="form-control" value="{{ $splitselesai[0] }}:{{ $splitselesai[1] }}" name="time2" id="time2" disabled=""> <span class="input-group-addon"> <span class="glyphicon glyphicon-time"></span> </span>
											</div>
										</div>
									</div>
