...
@section('content')
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row ">
				<div class="col-md-12">
					<form class="form-horizontal" method="POST" action="/portal/pemanfaatan/form/tambahcarousel" data-toggle="validator" enctype="multipart/form-data">
						@csrf
							...
							<div class="panel-wrapper collapse in" aria-expanded="true">
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input autocomplete="off" type="text" name="judul" class="form-control" id="judul" required value="{{ old('judul') }}">
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-8">
											<input autocomplete="off" type="text" name="url" class="form-control" id="url" value="{{ old('url') }}">
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-8">
											<input autocomplete="off" type="number" name="urut" class="form-control" id="urut" value="{{ old('urut') }}">
										</div>
									</div>

                                    <div class="form-group">
                                        <label for="image" class="col-md-2 control-label"> File <br> </label>
                                        <div class="col-md-8">
