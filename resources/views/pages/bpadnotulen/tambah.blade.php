							...
							<div class="panel-wrapper collapse in" aria-expanded="true">
								<div class="panel-body">
									...
									<div class="form-group">
										<label for="nm_emp" class="col-md-2 control-label"> ID<span style="color: red">*</span> </label>
										<div class="col-md-8">
											<input autocomplete="off" type="text" name="id_emp" class="form-control" value="{{ Auth::user()->id_emp ?? '' }}" required="">
										</div>
									</div>
