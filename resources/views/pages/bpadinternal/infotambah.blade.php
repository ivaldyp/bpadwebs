	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row ">
				...
				<div class="col-md-12">
					<form class="form-horizontal" method="POST" action="/portal/internal/form/tambahinfo" data-toggle="validator" enctype="multipart/form-data">
					@csrf
						<div class="panel panel-info">
							<div class="panel-heading"> Tambah Info Kepegawaian </div>
							<div class="panel-wrapper collapse in" aria-expanded="true">
								<div class="panel-body">
									<div class="form-group">
										<label for="info_judul" class="col-md-2 control-label"> Judul </label>
										<div class="col-md-8">
											<input type="text" class="form-control" id="info_judul" name="info_judul" autocomplete="off" required="" data-error="Judul harus diisi">
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											...
											<input type="text" class="form-control datepicker-autoclose" id="tgl_mulai" name="tgl_mulai" autocomplete="off">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<?php date_default_timezone_set('Asia/Jakarta'); ?>
											<input type="text" class="form-control datepicker-autoclose" id="tgl_akhir" name="tgl_akhir" autocomplete="off">
										</div>
									</div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="file" class="form-control" id="fileinfo" name="fileinfo">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
										...
										<div class="radio-list col-md-8">
											...
											<label class="radio-inline">
												<div class="radio radio-info">
													<input type="radio" name="info_tampil" id="tampil2" value="0" >
