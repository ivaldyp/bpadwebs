	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row ">
				...
				<div class="col-md-12">
					<form class="form-horizontal" method="POST" action="/portal/internal/form/tambaharsip" data-toggle="validator" enctype="multipart/form-data">
					@csrf
							...
							<div class="panel-wrapper collapse in" aria-expanded="true">
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-md-8"> 
											<input type="text" class="form-control" id="arsip_judul" name="arsip_judul" autocomplete="off" required="" data-error="Judul harus diisi">
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<select class="form-control select2" name="arsip_kat" id="arsip_kat" required="" data-error="Pilih salah satu">
												@foreach($kats as $kat)
													<option value="{{ $kat['singkatan'] }}">[{{ $kat['singkatan'] }}] - {{ $kat['nm_kat'] }}</option>
												@endforeach
											</select>
											<div class="help-block with-errors"></div>  
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<textarea class="form-control" id="arsip_detail" name="arsip_detail" autocomplete="off"></textarea>  
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
											<input type="file" class="form-control" id="filearsip" name="filearsip">
										</div>
									</div>
