						...
						<div class="panel-wrapper collapse in">
							<div class="panel-body">
								<div class="row " style="margin-bottom: 10px">
									<div class="col-md-1">
										@if ($access['zadd'] == 'y')
										<a href="/portal/internal/berita tambah"><button class="btn btn-info" style="margin-bottom: 10px">Tambah</button></a> 
										@endif
									</div>
								</div>
								<div class="row">
										...
										<table class="myTable table table-hover table-bordered">
											...
											<tbody>
												...
												<tr>
													...
													@if($access['zupd'] == 'y' || $access['zdel'] == 'y')
														<td class="col-md-1">
															<form method="POST" action="/portal/internal/berita ubah">
																@csrf
																@if($access['zupd'] == 'y')
			...
			<div id="modal-delete" class="modal fade" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<form method="POST" action="/portal/internal/form/hapusberita" class="form-horizontal">
						@csrf
