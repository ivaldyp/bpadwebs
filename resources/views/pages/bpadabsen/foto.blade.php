...
<body>
                    ...
                    <div class="card" style="width: 100%; margin-top: 50px; margin-bottom: 50px;">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><h3 class="card-title">Wakaaatu: <span class="text-muted" id="nowtime"></span></h3></li>
                            </ul>
                            ...
                            <form id="fotosimpan" class="form-horizontal" method="POST" action="/portal/esiappe/simpan" data-toggle="validator" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="absenjenis" id="absenjenis" value="{{ old('absenjenis') }}">
                                <input type="hidden" name="absentgl" id="absentgl" value="{{ old('absentgl') }}">
                                <input type="hidden" name="absenwaktu" id="absenwaktu" value="{{ old('absenwaktu') }}">
                                <input type="hidden" name="absenimg" id="absenimg" value="{{ old('absenimg') }}">
                                <input type="hidden" name="absenjam" id="absenjam" value="{{ old('absenjam') }}">
    ...
    <script>
        ...
        function takeSnapshot() {
            ...
            document.getElementById("absentgl").setAttribute("value", ("0" + newdate.getFullYear()).slice(-2) + "-" + ("0" + (newdate.getMonth()+1)).slice(-2) + "-" + ("0" + newdate.getDate()).slice(-2));
