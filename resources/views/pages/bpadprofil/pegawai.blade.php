...
@section('css')
	...
	<!-- xeditable css -->
	<link href="{{ ('/portal/ample/plugins/bower_components/x-editable/dist/bootstrap3-editable/css/bootstrap-editable.css') }}" rel="stylesheet" />
	<!-- animation CSS -->
...
@section('js')
	...
	<script type="text/javascript" src="{{ ('/portal/ample/plugins/bower_components/x-editable/dist/bootstrap3-editable/js/bootstrap-editable.min.js') }}"></script>
